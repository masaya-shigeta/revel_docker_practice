...
func (_ tApp) BindInput(
		) string {
	args := make(map[string]string)
	
	return revel.MainRouter.Reverse("App.BindInput", args).URL
}

func (_ tApp) JsonUnmarshal(
		) string {
	args := make(map[string]string)
	
	return revel.MainRouter.Reverse("App.JsonUnmarshal", args).URL
}

func (_ tApp) CreateTableSample(
		) string {
	args := make(map[string]string)
